...
export const Input = styled.input<StyledInputType>`
  ${({ theme, errorMessage, as }) => css`
    ...
    &:focus {
      border: ${theme.spacings.xxtiny} solid ${theme.colors.secondary};
      box-shadow: 0 0 ${theme.spacings.xtiny} 0 ${theme.colors.secondary};
      background: ${theme.colors.white};
    }
    &:focus
      + ${Label},
      ...
      top: 0;
      transform: translate(0, -50%);
      font-size: calc(${theme.font.sizes.xsmall} * 1.8);
      padding: 1rem;
      color: ${theme.colors.white};
...
export const ErrorMessage = styled.p`
  ${({ theme }) => css`
    color: ${theme.colors.warning};
    margin: ${theme.spacings.xsmall} 0 ${theme.spacings.large};
  `}
`
