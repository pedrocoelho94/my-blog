export default {
  ...
  reviewDetails: {
    ptbrTitle: 'Noite Passada em Soho',
    ...
    yearRelease: 2021,
    sinopse:
      'Uma jovem apaixonada por moda (Thomasin McKenzie) misteriosamente ganha a chance de voltar aos anos 60 e encontrar sua ídola, uma encantadora cantora aspirante (Anya Taylor-Joy). Mas a Londres dessa década não é o que parece e logo o tempo começa a desmorona com perigosas consequências.',
    cast: 'Thomasin McKenzie, Anya Taylor-Joy, Matt Smith, Diana Rigg, Terence Stamp.',
    poster: {
      id: '61a61c164aa09c2f980d5ffb',
      alternativeText: '',
      url: 'https://res.cloudinary.com/rabbitz/image/upload/v1638276116/Noite_Passada_em_Soho_POSTER_E_CARTAZ_OFICIAL_92841bf2bd.jpg'
    }
  }
}
